...
class MyUr:
    ...
    Ur_Home =     ("movej([-3.1258847, -1.5767304, 1.5449655, 1.58825, 1.57 , 0.04468043], a=1.0, v=0.6)" + "\n")
    Ur_TakePic =  ("movej([-0.6937, -2.04, 1.753, 0.06, 2.51, -0.178], a=1.0, v=1)" + "\n")
    
    Ur_DropOff =  ("movej([-2.2968533, -0.97476639, 2.65377313, -1.717404, 0.89395764, -0.008901179], a=1.0, v=0.6)" + "\n")
